...
namespace Cinematic\libraries\muqsit\invmenu;

use Cinematic\libraries\muqsit\invmenu\inventory\SharedInvMenuSynchronizer;
use Cinematic\libraries\muqsit\invmenu\session\InvMenuInfo;
use Cinematic\libraries\muqsit\invmenu\session\network\PlayerNetwork;
use Cinematic\libraries\muqsit\invmenu\transaction\DeterministicInvMenuTransaction;
use Cinematic\libraries\muqsit\invmenu\transaction\InvMenuTransaction;
use Cinematic\libraries\muqsit\invmenu\transaction\InvMenuTransactionResult;
use Cinematic\libraries\muqsit\invmenu\transaction\SimpleInvMenuTransaction;
...
class InvMenu implements InvMenuTypeIds{
	...
	/**
	 * @param (Closure(\Cinematic\libraries\muqsit\invmenu\transaction\DeterministicInvMenuTransaction) : void)|null $listener
	...
	/**
	 * @return \Cinematic\libraries\muqsit\invmenu\type\InvMenuType
	...
	/**
	 * @param (Closure(\Cinematic\libraries\muqsit\invmenu\transaction\InvMenuTransaction) : InvMenuTransactionResult)|null $listener
	 * @return self
	 */
